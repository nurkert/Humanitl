...
impl Fixture {
    fn new() -> Self {
        ...
        // Über `common::write_program`: Die Datei wird gleich ausgeführt, und
        // ein geerbter Schreib-Deskriptor eines anderen Fadens gäbe `ETXTBSY`
        // (HUM-134).
        common::write_program(&shim, PASSTHROUGH_SHIM);
